...
app.post("/delete/:id", async (req, res) => {
  ...
  try {
    ...
    if (deletee) {
      ...
      res.send(
        "<script>window.alert(`error in deleting`);window.location.href='/';</script>"
      );
    }
  } catch (error) {
    console.log("error");
...
app.post("/update/:id", async (req, res) => {
  ...
  try {
    ...
    if (updatedItem) {
      ...
      res.send(
        "<script>window.alert(`error in updating`);window.location.href='/';</script>"
      );
    }
  } catch (error) {
...
app.post("/upload", (req, res) => {
  ...
  try {
    ...
    res.send(
      `<script>window.alert("error in saving");window.location.href="/";</script>`
    );
  }
});
